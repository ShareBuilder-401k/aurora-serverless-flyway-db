...
Created at: 2020-04-24T22:15:58.145Z
Server version: PostgreSQL 12.2 on x86_64-pc-linux-musl, compiled by gcc (Alpine 9.2.0) 9.2.0, 64-bit
## Schema: public
...
#### public.test_sql_table

column | comment | type | length | default | constraints | values
--- | --- | --- | --- | --- | --- | ---
**id** _(pk)_ |  | integer |  | nextval('test_sql_table_id_seq'::regclass) | NOT NULL | 
test_message |  | text |  |  |  | 
# Database Documentation

Created at: 2020-04-24T22:41:16.351Z
Server version: PostgreSQL 12.2 on x86_64-pc-linux-musl, compiled by gcc (Alpine 9.2.0) 9.2.0, 64-bit
## Schema: public
